...
Load.prototype = {
   ...
   preload: function() {
      ...
      let spriteList = ['arrow','crossbowBolt.png','hero','hero.png','baddie','baddieOneFrame.png'];

      let sheetList = ['platHero','hero-tall.png',64,64,'axeMan-enemy','axeMan.png',64,64,'swordsMan-enemy','swordsMan.png',64,64,'lesserDemon','lesserDemon.png',64,64,'overallDude-npc','overallDude.png',64,64,'skirtDudette-npc','skirtDudette.png',64,64,'bossDemon','bossDemon.png',340,340];
