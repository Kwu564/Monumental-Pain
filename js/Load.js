...
Load.prototype = {
   ...
   preload: function() {
      ...
      // Varius images
      let imgList = ['collider','collider.png','kevn-bg','kevn-bg.png','textbox','textbox.png','titleart','TitleArt.png', 'gameOver', 'gameOver.png','hatu-bg','hatu-bg.png','boss-bg','boss-bg.png','healthbar','healthbar.png','healthbarback','healthbarback.png','swordImpact','swordImpact.png','smallWeaponImpact','smallweaponImpact.png'];
